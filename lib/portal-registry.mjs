export const APP_REGISTRY = [
  {
    ...
    href: 'https://revilorasec.github.io/rh-livion/?v=1.8.4',
  ...
  },
  {
    ...
    href: 'https://revilorasec.github.io/fretes-livion/?v=1.3.6',
    companies: ['LIVION'],
    actions: [
  ...
  },
  {
    ...
    href: 'https://portal.livionsolutions.com.br/despesas-reembolsos-v2.html?v=20',
    companies: ['LIVION', 'RHCS'],
    actions: [
  ...
  },
  {
    ...
    icon: '🛒',
    eyebrow: 'Suprimentos & Operações',
    title: 'Compras e Cotações',
    description: 'Solicitações, comparação de fornecedores, pedidos e recebimentos integrados ao estoque.',
    href: 'https://portal.livionsolutions.com.br/compras-cotacoes.html?v=3',
    companies: ['LIVION'],
    actions: [
      { key: 'compras.visualizar', label: 'Visualizar compras e cotações' },
      { key: 'compras.criar_solicitacao', label: 'Criar solicitações' },
      { key: 'compras.cotar', label: 'Registrar cotações' },
      { key: 'compras.aprovar', label: 'Aprovar compras' },
      { key: 'compras.emitir_pedido', label: 'Emitir pedidos' },
      { key: 'compras.receber', label: 'Receber e dar entrada no estoque' },
      { key: 'compras.visualizar_valores', label: 'Visualizar valores' },
      { key: 'compras.gerenciar_fornecedores', label: 'Gerenciar fornecedores' },
      { key: 'compras.exportar', label: 'Exportar dados' },
    ],
  },
  {
    key: 'vtal',
    icon: '✓',
    eyebrow: 'Propostas & Requisitos',
    title: 'V.Tal',
    description: 'Checklist da RFP com 268 requisitos, responsáveis, observações e classificação de atendimento.',
    href: 'https://portal.livionsolutions.com.br/vtal.html?v=1',
    companies: ['LIVION'],
    actions: [
      { key: 'vtal.visualizar', label: 'Visualizar checklist V.Tal' },
      { key: 'vtal.editar', label: 'Editar checklist V.Tal' },
      { key: 'vtal.exportar', label: 'Exportar checklist V.Tal' },
    ],
  },
];
