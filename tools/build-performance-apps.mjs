...
function buildCombined() {
  ...
  html = replaceOnce(html, `money=n=>(Number(n)||0).toLocaleString('pt-BR',{style:'currency',currency:'BRL'})`, `money=n=>presentationMode&&!document.querySelector('#tab-bonus.active')?'Valor oculto':(Number(n)||0).toLocaleString('pt-BR',{style:'currency',currency:'BRL'})`, 'moeda combinado');
