...
values('compras-cotacoes','Compras e Cotações','Solicitações, comparação de fornecedores, pedidos e recebimentos integrados ao estoque.','🛒','Suprimentos & Operações','https://portal.livionsolutions.com.br/compras-cotacoes.html?v=2',true,'INTERNO','["INTERNO"]'::jsonb,'["LIVION"]'::jsonb,
